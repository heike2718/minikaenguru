...
Klassen und Kinderdaten können aber auch ohne das Hochladen einer Datei erfaast werden und jederzeit gelöscht und geändert werden.
...
es anschließend in Liste der Kinder der neuen Klasse.
