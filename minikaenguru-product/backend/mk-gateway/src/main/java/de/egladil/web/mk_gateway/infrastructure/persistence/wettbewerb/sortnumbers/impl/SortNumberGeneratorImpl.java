...
// (c) Heike Winkelvoß
// =====================================================
package de.egladil.web.mk_gateway.infrastructure.persistence.wettbewerb.sortnumbers.impl;

import java.util.concurrent.atomic.AtomicLong;

import de.egladil.web.mk_gateway.infrastructure.persistence.wettbewerb.dao.SortnumberHibernateRepositoryImpl;
import de.egladil.web.mk_gateway.infrastructure.persistence.wettbewerb.sortnumbers.SortNumberGenerator;
import de.egladil.web.mk_gateway.infrastructure.persistence.wettbewerb.sortnumbers.SortedTable;
import de.egladil.web.mk_gateway.infrastructure.persistence.wettbewerb.sortnumbers.SortnumberRepository;
