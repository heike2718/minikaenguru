...
public class PersistenterVeranstalter extends ConcurrencySafeEntity {
	...
	public static final String FIND_BY_PARTIAL_UUID_QUERY = "PersistenterVeranstalter.FIND_BY_PARTIAL_UUID_QUERY";

	public static final String FIND_BY_PARTIAL_NAME_QUERY = "PersistenterVeranstalter.FIND_BY_PARTIAL_NAME_QUERY";

	public static final String FIND_BY_PARTIAL_EMAIL_QUERY = "PersistenterVeranstalter.FIND_BY_PARTIAL_EMAIL_QUERY";

	public static final String FIND_BY_TEILNAHMENUMMER_QUERY = "PersistenterVeranstalter.FIND_BY_TEILNAHMENUMMER_QUERY";

	public static final String FIND_BY_ZUGANGSSTATUS_QUERY = "PersistenterVeranstalter.FIND_BY_ZUGANGSSTATUS_QUERY";
