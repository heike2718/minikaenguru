...
@NamedQueries({
	@NamedQuery(name = PersistenteDownloadInfo.FIND_DOWNLOAD_BY_VERANSTALTER_JAHR, query = "select d from PersistenteDownloadInfo d where d.veranstalterUuid = :veranstalterUuid AND d.jahr = :jahr order by d.sortNumber"),
	@NamedQuery(name = PersistenteDownloadInfo.FIND_DOWNLOAD_BY_VERANSTALTER_JAHR_TYPE, query = "select d from PersistenteDownloadInfo d where d.veranstalterUuid = :veranstalterUuid AND d.jahr = :jahr and d.downloadType = :downloadType order by d.sortNumber") })
