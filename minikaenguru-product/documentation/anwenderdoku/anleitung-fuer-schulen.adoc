...
Eine Anleitung für den Firefox finden Sie hier: https://support.mozilla.org/de/kb/neueste-surf-such-und-download-chronik-loeschen#w_eine-einzelne-website-aus-ihrer-chronik-loschen[Leeren des Caches - Firefox].
