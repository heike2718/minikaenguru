...
// (c) Heike Winkelvoß
// =====================================================
package de.egladil.web.minikaenguru_statistik.infrastructure.error;
...
/**
 * MinikaenguruStatistikExceptionMapper
 */
@Provider
public class MinikaenguruStatistikExceptionMapper implements ExceptionMapper<Throwable> {

	private static final Logger LOGGER = LoggerFactory.getLogger(MinikaenguruStatistikExceptionMapper.class);
	...
	public Response toResponse(final Throwable exception) {
		...
		if (exception instanceof MinikaenguruStatistikCommunicationExcepion) {
