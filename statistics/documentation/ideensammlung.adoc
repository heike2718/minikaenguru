...
* je Aufgabe: Anzahl Antworten zu jedem Antwortbuchstaben als Balkendiagramm

* Anzahl Kinder je Punktintervall

* Rohpunkte irgendwie auflisten (als Tabelle oder als gekippte Balkengrafik)
