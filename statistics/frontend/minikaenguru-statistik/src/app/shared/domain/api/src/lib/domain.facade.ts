...
import { domainActions, fromDomain } from '@mks/domain-data';

import { Store, select } from "@ngrx/store";
import { Observable, Subscription, take } from "rxjs";
import { Klassenstufe, KlassenstufeGUIModel, WettbewerbDetailsGUIModel, WettbewerbOverview } from "@mks/domain-model";
