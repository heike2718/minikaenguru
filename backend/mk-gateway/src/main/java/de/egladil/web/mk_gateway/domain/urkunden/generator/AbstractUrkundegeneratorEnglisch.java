...
/**
 * AbstractUrkundegeneratorEnglisch
 */
public abstract class AbstractUrkundegeneratorEnglisch implements UrkundeGenerator {

	private static final Logger LOG = LoggerFactory.getLogger(AbstractUrkundegeneratorEnglisch.class);
	...
	public byte[] generiereUrkunde(final AbstractDatenUrkunde datenUrkunde) {
		...
		try (final ByteArrayOutputStream os = new ByteArrayOutputStream()) {
			...
			// header
			int verschiebungVonTop = headerRenderer.printSectionAndShiftVerticalPosition(content, "Math competition");
			...
			LOG.error("Exception beim Generierem einer Kängurusprungurkunde en: " + e.getMessage(), e);
