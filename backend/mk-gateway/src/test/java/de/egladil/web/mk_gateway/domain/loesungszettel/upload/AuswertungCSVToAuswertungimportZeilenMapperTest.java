...
public class AuswertungCSVToAuswertungimportZeilenMapperTest {
	...
	void should_mapperIgnoreLinesUpToUeberschrift_when_csvFromExcel() {
		...
		lines.add("Karl,r,3,r,3.0,r,3.0,r,3.0,r,3.0,r,4.0,r,4.0,f,-1.0,r,4.0,r,4.0,r,5.0,r,5.0,r,5.0,r,5.0,f,-1.25,63.75");
	...
	void should_mapperWork_when_ListEmpty() {
		...
		// Act
		List<AuswertungimportZeile> zeilen = new AuswertungCSVToAuswertungimportZeilenMapper().apply(new ArrayList<>());
