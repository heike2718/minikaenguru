...
public class PermittedRolesInMemoryRepositoryTest {
	...
	class AdminAPITest {
		...
		@Test
		void should_permittedRollen_getStatistikKinder_beOk() {

			// Act
			List<Rolle> rollen = repository.permittedRollen("/admin/statistik/kinder", HttpMethod.GET);
		...
		@Test
		void should_permittedRollen_getStatistikLoesungszettel_beOk() {

			// Act
			List<Rolle> rollen = repository.permittedRollen("/admin/statistik/loesungszettel", HttpMethod.GET);
		...
		@Test
		void should_permittedRollen_getStatistikDownloads_beOk() {

			// Act
			List<Rolle> rollen = repository.permittedRollen("/admin/statistik/downloads", HttpMethod.GET);
