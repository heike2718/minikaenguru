...
public class StatistikServiceTest {
	...
	void should_erstelleStatistikFuerEinzelteilnahme_call_AuthService() {
		...
		Mockito.when(authService.checkPermissionForTeilnahmenummer(userIdentifier, teilnahmeID, true))
		...
		try {
			...
			statistikService.erstelleStatistikFuerEinzelteilnahme(teilnahmeIdentifier, userUuid);
