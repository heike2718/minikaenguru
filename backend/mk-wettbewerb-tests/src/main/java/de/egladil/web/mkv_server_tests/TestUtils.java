...
public class TestUtils {
	...
	public static LoesungszettelAPIModel createLoesungszettelNeuKlasseEinsKreuzeABC(final String kindUuid) {
		...
		LoesungszettelAPIModel requestData = new LoesungszettelAPIModel().withKindID(kindUuid).withKlassenstufe(Klassenstufe.EINS)
			.withUuid("neu").withZeilen(zeilen);

		return requestData;
	}

	public static LoesungszettelAPIModel createLoesungszettelNeuKlasseEinsKreuzeDEN(final String kindUuid) {
