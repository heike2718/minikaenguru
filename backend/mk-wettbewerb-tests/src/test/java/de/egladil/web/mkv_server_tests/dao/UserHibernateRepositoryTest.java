...
/**
 * UserHibernateRepositoryTest
 */
public class UserHibernateRepositoryTest extends AbstractIT {
	...
	void init() {
		...
		super.setUp();
		userRepository = UserHibernateRepository.createForIntegrationTest(entityManagerWettbewerbDB);
	}
