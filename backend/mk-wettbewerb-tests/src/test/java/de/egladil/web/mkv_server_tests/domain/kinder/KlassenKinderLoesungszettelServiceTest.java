...
/**
 * KlassenKinderLoesungszettelServiceTest
 */
public class KlassenKinderLoesungszettelServiceTest extends AbstractIT {
	...
	protected void setUp() {
		...
		super.setUp();
		klassenRepository = KlassenHibernateRepository.createForIntegrationTest(entityManagerWettbewerbDB);
